<div class="container">
    <nav>
        <div class="nav-grid">
            ...
            <li id="<?php echo (isset($TitlePage) && $TitlePage == 'Quản Lý Tin Tức') ? 'Select' : ''; ?>"><a href="admin.php?Page=quan_ly_bai_viet">Quản Lý Tin Tức</a></li>
            <li id="<?php echo (isset($TitlePage) && $TitlePage == 'Quản Lý Bình Luận Tin Tức') ? 'Select' : ''; ?>"><a href="admin.php?Page=quan_ly_binh_luan_tin_tuc">Quản Lý Bình Luận Tin Tức</a></li>
