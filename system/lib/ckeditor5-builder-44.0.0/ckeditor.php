<!-- 
	...
	<link rel="stylesheet" href="system/lib/ckeditor5-builder-44.0.0/style.css">
	<link rel="stylesheet" href="system/lib/ckeditor5-builder-44.0.0/ckeditor5/ckeditor5.css">


	<!-- <div class="main-container">
			<div class="editor-container editor-container_classic-editor" id="editor-container">
				<div class="editor-container__editor"><div id="mota"></div></div>
			</div>
		</div> -->
	<script type="importmap">
		{
			"imports": {
				"ckeditor5": "system/lib/ckeditor5-builder-44.0.0/ckeditor5/ckeditor5.js",
				"ckeditor5/": "system/lib/ckeditor5-builder-44.0.0/ckeditor5/"
			}
		}
		</script>
	<script type="module" src="system/lib/ckeditor5-builder-44.0.0/main.js"></script>
